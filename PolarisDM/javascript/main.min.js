...
frmSearch.search(a))},show:function(){var a=toolBar.getTopHeight(!0);this.menu.animate({top:a},300);this.visible=!0},hide:function(){this.menu.animate({top:-60},300);this.visible=!1},showOrHide:function(){!0===this.visible?this.hide():this.show()},changeLanguage:function(){this.searchBarInput.attr("placeholder",FormInfo.getFormTitle("search"))}});var PcSearchItem=Class({create:function(a,b){b.fontColor=this.mainColor;this._super(a,b)}}).extend(SearchItem);var PcSearchForm=Class({create:function(a){this.elements=new SearchElements(this);this._super(a)},onCreate:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.95*this.formOpacity),color:this.fontColor});this.searchResult.css({"border-bottom":"1px solid "+this.mainColorObj.rgba(.1)});this.progressBar.css({"background-color":this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));
this.stage.append(this.close);this.content=$("<div class='search_content'></div>");this.stage.append(this.content);this.content.append(this.input);this.content.append(this.searchButton);this.content.append(this.searchPageSwiper);this.content.append(this.searchResult);this.content.append(this.$matchType);this.content.append(this.searchSwiper);this.parent.append(this.stage)},newSearchItem:function(a,b){return new PcSearchItem(a,b)},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.95),
color:this.fontColor})},afterSearchThumbs:function(){this.height=windowHeight-20;this.searchSwiper.css("height",this.height-332+"px")},afterSearchText:function(){this.height=windowHeight-20;this.searchSwiper.css("height",this.height-132+"px");this.searchPageSwiper.css({display:"none"})},onResize:function(){toolBar.getWidth();this.width=287;this.height=windowHeight-20;this.stage.css({height:this.height+"px",top:"0px"});this.searchSwiper.css("height",this.height-132+"px");this.elements.refresh()},getList:function(){return this.elements.getList()},
onShow:function(){this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.input.focus();BookInfo.getBook().addSearchHighlight()},onHide:function(){BookInfo.getBook().clearSearchHighlight()}}).extend(SlideRightForm);var phoneGotoPage=Class({create:function(a){this.mainColor=Color(bookConfig.toolbarColor);this.iconColor=Color(bookConfig.iconColor);this.menu=$("<div id='menu' style='position:absolute;width:100%;height:90px;z-index:98;bottom:-100px;overflow:hidden;'></div>");this.background=$("<div id='background' style='position:absolute;width:100%;height:90px;'></div>");this.contentBox=$("<div id='contentBox' class='phoneGotoPageContent' style='position:absolute;width:100%;height:90px;'></div>");this.direction=
...
Class("PCButtonQueue",{sort:function(){1<=this.buttons.length&&(this.btnMore.addTo(this.container.topBar),this.btnMore.title.direction=TextBubble.LEFT,this.btnMore.$button.css({background:Color(bookConfig.toolbarColor).rgba(bookConfig.ToolBarAlpha)}));for(var a=0;a<this.buttons.length;a++){var b=this.buttons.get(a);b==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.DEFAULT,b.title=!1);"WeChatShareButton"==b.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.LEFT);
"TelephoneNumberButton"==b.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.LEFT);b.addTo(this.extended)}},getButtonsWidth:function(a){return 48*a}}).extend("ButtonQueue");Class("MobileButtonQueue",{sort:function(a,b){a=this.edtNumber.width+2*this.edtNumber.space+4*this.buttonWidth;this.addPageButtons(a,(this.container.width-a)/2);this.buttons.each(function(c){c.addTo(this.extended)}.bind(this))}}).extend("ButtonQueue");Class("PCToolbar",{initBar:function(){this.topBar=$('<div class="fbTopBar" id = "fbTopBar"></div>');this.logoBar=$('<div class="logoBar" id = "logoBar"></div>');this.extendRrrow=$("<div class='extendArrow' style='border-bottom: 7px solid "+this.color.rgba(this.topBarAlpha)+";'></div>");this.leftBar=$("<div class='leftPageBar' ></div>");this.rightBar=$("<div class='rightPageBar'></div>");VolumeControlBar.config={color:this.color.toString(),iconColor:Color(bookConfig.iconColor).toString(),direction:VolumeControlBar.DEFAULT};
bookConfig.ToolBarVisible&&this.parent.append(this.topBar).append(this.logoBar);bookType!=BookType.catalog_book&&bookConfig.flipshortcutbutton&&(this.parent.append(this.leftBar),this.parent.append(this.rightBar),this.showFirstOrLast());this.initPageButtons()},initPageButtons:function(){this.btnFirst=this.pickButton("first");this.btnPrevious=this.pickButton("previous");this.btnNext=this.pickButton("next");this.btnLast=this.pickButton("last");rightToLeft?(this.btnNext.addTo(this.leftBar),this.btnNext.setPosition(0,
10),bookConfig.isFirstLastShortcutVisible&&(this.btnLast.addTo(this.leftBar),this.btnLast.setPosition(0,59)),this.btnPrevious.addTo(this.rightBar),this.btnPrevious.$button.css({right:"0",top:"10px"}),bookConfig.isFirstLastShortcutVisible&&(this.btnFirst.addTo(this.rightBar),this.btnFirst.$button.css({right:"0",top:"59px"}))):(this.btnPrevious.addTo(this.leftBar),this.btnPrevious.setPosition(0,10),bookConfig.isFirstLastShortcutVisible&&(this.btnFirst.addTo(this.leftBar),this.btnFirst.setPosition(0,
59)),this.btnNext.addTo(this.rightBar),this.btnNext.$button.css({right:"0",top:"10px"}),bookConfig.isFirstLastShortcutVisible&&(this.btnLast.addTo(this.rightBar),this.btnLast.$button.css({right:"0",top:"59px"})));var a=bookConfig.flipShortcutButtonColor||bookConfig.iconColor;this.btnNext.changeColor(a);this.btnLast.changeColor(a);this.btnPrevious.changeColor(a);this.btnFirst.changeColor(a);this.initPageButton(this.btnFirst);this.initPageButton(this.btnPrevious);this.initPageButton(this.btnNext);this.initPageButton(this.btnLast)},
resetButtonColor:function(){this._super();for(var a=bookConfig.flipShortcutButtonColor||bookConfig.iconColor,b=[this.btnFirst,this.btnPrevious,this.btnNext,this.btnLast],c=0;c<b.length;c++){var d=b[c];d.resetImg();d.color=Color(a);d.fontColor=Color(bookConfig.iconFontColor);d.changeIconColor(a);d.changeCaptionColor(bookConfig.iconFontColor)}},initPageButton:function(a){a.changeColor();a.$button.attr("class","pageButton");var b=bookConfig.flipShortcutButtonBackgroundColor||this.color.rgba(bookConfig.ToolBarAlpha);
a.$button.css({background:b});a.$button.bind("mouseenter",function(c){a.$button.css({opacity:"0.7"})}.bind(this));a.$button.bind("mouseleave",function(c){a.$button.css({opacity:"1"})}.bind(this))},setButtonTitle:function(a){var b=a.getClassName();"LastPageButton"==b||"NextPageButton"==b||"FirstPageButton"==b||"PreviousPageButton"==b?a.setTitle(""):"WeChatShareButton"==a.getClassName()?global.WeChatShareImg=new WeChatShare({parent:this.parent,color:"#fff",textColor:bookConfig.toolbarColor,margin:10,
padding:10,direction:2,arrowHeight:12,arrowWidth:12}):"TelephoneNumberButton"==a.getClassName()?global.PcTelephoneNumberFrame=new PcTelephoneNumberBubble({parent:this.parent,color:a.fontColor,textColor:this.color,margin:4,padding:15,arrowHeight:8,arrowWidth:8}):(b=new SolidArrowTextBubble({parent:this.parent,text:a.caption,color:a.fontColor,textColor:this.color,margin:3,padding:6,direction:2,arrowHeight:4,arrowWidth:4}),a.setTitle(b))},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);
global.moreBar=this.extendedBar;this.extendedBar.$bar.append(this.extendRrrow)},addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},getTopRightButtonWidth:function(){return this.topRightButton&&this.topRightButton.width()&&this.topRightButton.width()+25||0},onResize:function(a,
b){this.isRenderToolbar&&(void 0==a?this.parent.width():parseInt(a),b=void 0==b?this.parent.height():parseInt(b),(a=this.getTopRightButtonWidth())?this.topBar.css({right:a+"px"}):this.topBar.css({right:"25px"}),a=this.leftBar.height(),b=(b-a)/2,this.leftBar.css({top:b+"px"}),this.rightBar.css({top:b+"px"}),this.resetButtonPosition(),bookConfig.appLogoIcon&&this.logoBar.find("img")[0]&&this.logoBar.find("img").css({top:"0",left:"0"}))},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,
container:{topBar:this.topBar,body:this.buttonBar,width:this.buttonBarWidth},extended:this.extendedBar.$bar})).sort();this.extendedBar.resize(this.buttonsInExtendedBar());this.extendedBar.hide();this.buttons.each(function(a){a.changeColor()}.bind(this))},getTopHeight:function(){return 0},getButtonBarWidth:function(){for(var a=0,b=0;b<this.buttons.length;b++){var c=this.buttons.get(b);c.$parent==this.buttonBar&&(a+=c.width()+10)}return 80},afterButtonClick:function(a){this._super(a)},getButtonWidth:function(){for(var a=
0;a<this.buttons.length;a++);},getWidth:function(){return 0},getLeftWidth:function(){return 0},getRightWidth:function(){return 0},show:function(){if(this.isRenderToolbar&&!this.isMoving&&!this.visible)if(this._super(),isIE8())this.leftBar.css({display:"block"}),this.rightBar.css({display:"block"}),this.topBar.css({display:"block"});else{var a=transformCSS({tran:{x:0,y:0}});animateOnce(this.topBar,a,500);a=transformCSS({tran:{x:0,y:0}});animateOnce(this.leftBar,a,500);a=transformCSS({tran:{x:0,y:0}});
animateOnce(this.rightBar,a,500)}},hide:function(){if(this.isRenderToolbar&&!this.isMoving&&this.visible)if(this._super(),isIE8())this.leftBar.css({display:"none"}),this.rightBar.css({display:"none"}),this.topBar.css({display:"none"});else{var a=transformCSS({tran:{x:this.topBar.width()+25,y:0}});animateOnce(this.topBar,a,500);a=transformCSS({tran:{x:-this.leftBar.width(),y:0}});animateOnce(this.leftBar,a,500);a=transformCSS({tran:{x:this.rightBar.width(),y:0}});animateOnce(this.rightBar,a,500)}},
changeLanguage:function(){this.buttons.each(function(a){a.changeLanguage()});this.resetBottomBarWidth()},showFirstOrLast:function(){if(bookConfig.flipshortcutbutton&&this.isRenderToolbar){var a=-1<BookInfo.getCurrentPages().indexOf(bookConfig.totalPageCount);if(bookConfig.RightToLeft){if(1==BookInfo.getCurrentPageIndex()){this.leftBar.fadeIn(200);this.rightBar.hide();return}if(a){this.leftBar.hide();this.rightBar.fadeIn(200);return}}else{if(1==BookInfo.getCurrentPageIndex()){this.leftBar.hide();this.rightBar.fadeIn(200);
return}if(a){this.leftBar.fadeIn(200);this.rightBar.hide();return}}this.leftBar.fadeIn(200);this.rightBar.fadeIn(200)}},resetFlipshortcutbutton:function(){this.isRenderToolbar&&bookType!=BookType.catalog_book&&(bookConfig.flipshortcutbutton?(this.parent.has(this.leftBar).length||(this.parent.append(this.leftBar),this.parent.append(this.rightBar)),this.showFirstOrLast()):(this.leftBar.fadeOut(200),this.rightBar.fadeOut(200)))}}).extend("Toolbar");
Class("PCExtendedBar",{show:function(a){if(1!=this.isMoving&&1!=this.visible){this.visible=this.isMoving=!0;var b=a.left+a.width-this.$bar.width()+12;this.$bar.css({left:b+"px",top:a.top+42+"px"});var c=0;this.$bar.css({display:"block",opacity:0});var d=function(){c+=.1;this.$bar.css({opacity:c});equals(c,1)&&(d.stop(),this.isMoving=!1)}.interval(this,40)}},resize:function(a){for(var b=0;b<a.length;b++)a.get(b);this.width=72;this.height=72*a.length+10;this.height>=windowHeight-72?(this.height=windowHeight-
72,this.width=3*this.width+40):this.width+=20;this.$bar.css({width:this.width+"px"})}}).extend("ExtendedBar");var hexcase=0,b64pad="",chrsz=8;function compareov(){var a=Date.parse(new Date);return orgt(a)===vldt(a)}function orgt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}function vldt(a){return binl2hex(core_hx(str2binl(a),a.length*chrsz))}
